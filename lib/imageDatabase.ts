...
export const OFFICIAL_ANIME_DATABASE: FranchiseImageRule[] = [
  ...
  {
    keywords: ["apothecary", "kusuriya", "maomao", "jinshi"],
    imageUrl: "https://cdn.myanimelist.net/images/anime/1708/138033.jpg",
    franchise: "The Apothecary Diaries"
  },
  {
    keywords: ["dungeon meshi", "delicious in dungeon", "laios", "marcille", "senshi", "trigger"],
    imageUrl: "https://images.unsplash.com/photo-1534447677768-be436bb09401?q=80&w=1200&auto=format&fit=crop",
    franchise: "Delicious in Dungeon"
  },
  {
    keywords: ["suzume", "makoto shinkai", "weathering with you", "your name", "kimi no na wa"],
    imageUrl: "https://upload.wikimedia.org/wikipedia/en/7/7f/Suzume_no_Tojimari_poster.jpg",
